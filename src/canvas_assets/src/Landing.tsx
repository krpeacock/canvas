    ...
    <>
      <main>
        ...
        <Flex wrap gap="1rem" width="100%" justifyContent="space-evenly">
          ...
          >
            <>
              ...
              <p>
                These users rejected my intent, and threw it back at me. This
                art was drawn in the medium of a smart contract, and the rules I
                ...
                by bypassing the UI and talking directly with the Canister
                running the project.
              </p>
            </>
          </NftPreview>
          ...
          >
            <>
              <p>
                ...
                hand-drawn art to arise. Surprisingly, you can see that two of
                the large screenshots appear to have partially reverted. The
                story becomes clearer if you toggle the transparency.
              </p>
              <p>
                In reality, another user wrote a new bot that fought back
                against the antithesis, attempting to restore the canvas from a
                screenshot I had shared the previous day. Both bots were working
                continuously until the very end, fighting to establish their own
                preferred version of the canvas, leading to an in-between state
                of noise, revealing traces of what was there before.
              </p>
            </>
          </NftPreview>
        </Flex>
        ...
        <p>
          ...
          <a href="https://www.catf.us/">Clean Air Task Force</a>, while the
          rest will go to the Canvas team. The auction date is still to be
          announced. We are excited to announce that these canvases will be the
          first NFT's ever sold at auction on the Internet Computer!
        </p>
        <p>
          We will also be working with the Entrepot team to distribute our Pixel
          NFT's. Once we get the claiming mechanism in place, you will be able
          to return to this site at any point and claim your NFT, which you can
          then view and trade in the Entrepot marketplace. Your pixel will be a
          random non-transparent pixel from the canvas.
        </p>
        <h2>Archive</h2>
